...
/**
 * This parse the attribute, for the radio button frontend form field.
 */
final class RadioButtonField extends AbstractFormField
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return $widget instanceof FormRadioButton;
    }
}
