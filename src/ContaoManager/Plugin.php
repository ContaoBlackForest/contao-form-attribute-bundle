...
namespace BlackForest\Contao\Form\Attribute\ContaoManager;

use BlackForest\Contao\Form\Attribute\BlackForestContaoFormAttributeBundle;
...
final class Plugin implements BundlePluginInterface
{
    ...
    {
        return [
            BundleConfig::create(BlackForestContaoFormAttributeBundle::class)
                ->setLoadAfter(
                    [
